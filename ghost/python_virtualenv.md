...
## Testing
I run Arch Linux on my local system, but I'd like to test out the other installations to verify the information I'm trying to share is correct.  I can easily fire up an ubuntu or centos box with a little help from docker.  To test out Mac OS I'll bring up a vm with vagrant and virtualbox.
